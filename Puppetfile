...
mod 'epel',                  :git => 'git://github.com/stahnma/puppet-module-epel.git',                         :ref => '1.3.0'
mod 'stdlib',                :git => 'git://github.com/puppetlabs/puppetlabs-stdlib.git',                       :ref => '4.24.0'
...
mod 'jenkins',               :git => 'git://github.com/voxpupuli/puppet-jenkins.git',                           :commit => '23df7764d58aed80b573621b102f82a702217a7a'
...
mod 'puppetserver_perf_driver',      :git => 'git@github.com:magisus/puppetlabs-puppetserver_perf_driver.git',             :ref => 'fix-jenkins'
